      ...
      >
        <div className="border-b border-zinc-200 px-5 py-4 dark:border-zinc-800">
          ...
          {showAddForm && onAddMatch ? (
            <form
              className="mt-3 grid gap-3 rounded-xl border border-zinc-200 bg-zinc-50 p-3 dark:border-zinc-800 dark:bg-zinc-950 sm:grid-cols-2"
              onSubmit={(event) => {
            ...
            >
              <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-300">
                ...
                <input
                  ...
                  onChange={(event) => updateDraft("home_team", event.target.value)}
              ...
              <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-300">
                ...
                <input
                  ...
                  onChange={(event) => updateDraft("away_team", event.target.value)}
                  className="mt-1 w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 outline-none focus:border-blue-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50"
                />
              </label>
              <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-300">
                ...
                <input
                  ...
                  onChange={(event) => updateDraft("home_win", event.target.value)}
                  className="mt-1 w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 outline-none focus:border-blue-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50"
                />
              </label>
              <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-300">
              ...
              <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-300">
                ...
                <input
                  ...
                  onChange={(event) => updateDraft("away_win", event.target.value)}
                  className="mt-1 w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 outline-none focus:border-blue-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50"
                />
              </label>
              <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-300">
                ...
                <input
                  type="datetime-local"
                  value={draft.kickoff}
                  onChange={(event) => updateDraft("kickoff", event.target.value)}
                  className="mt-1 w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 outline-none focus:border-blue-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50"
                />
              </label>
              {addError ? (
                ...
                <p className="text-xs text-zinc-500 dark:text-zinc-400 sm:col-span-2">
                  Uses the same 1X2 fields as SportPesa. The match is classified
                  from those odds. Kickoff defaults to now if left blank.
                </p>
              )}
              <button
                type="submit"
